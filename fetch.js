...
(function() {
  var Promise, _stdio, argv, child_process, clone, cloneParams, clone_shallow, clone_to, code_cloned, emitter, events, fs, isTmpPresent, path, repository_url, spawn, spawnSync, tmp_path, tmp_ready, tmp_updated, usage;
  ...
  if (isTmpPresent()) {
    ...
    tmp_ready = code_cloned.then(function() {
